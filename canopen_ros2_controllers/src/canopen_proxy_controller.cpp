  ...
  const rclcpp_lifecycle::State & /*previous_state*/)
{
                              ...
                              std_srvs::srv::Trigger::Response::SharedPtr response)
  {
    ...
    // report success
    response->success = static_cast<bool>(
      command_interfaces_[CommandInterfaces::NMT_RESET_FBK].get_optional().value_or(0.0));
    // reset to nan
                              ...
                              std_srvs::srv::Trigger::Response::SharedPtr response)
  {
    ...
    // report success
    response->success = static_cast<bool>(
      command_interfaces_[CommandInterfaces::NMT_START_FBK].get_optional().value_or(0.0));
  ...
  const rclcpp::Time & time, const rclcpp::Duration & /*period*/)
{
  ...
  if (rpdo_rt_publisher_ && rpdo_rt_publisher_->trylock())
  {
    ...
    {
      RCLCPP_WARN(
        get_node()->get_logger(), "RPDO state interfaces have invalid/uninitialized values.");
    }
